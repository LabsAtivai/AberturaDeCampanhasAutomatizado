...
export default {
  ...
  async mounted() {
    const res = await axios.get('https://api-aberturas.labsativa.com.br/api/campaigns/get-emails');
  ...
  methods: {
    async onSubmit() {
      try {
        ...
        await axios.post('https://api-aberturas.labsativa.com.br/api/campaigns', {
        ...
        const response = await axios.get(
          'https://api-aberturas.labsativa.com.br/api/campaigns/download',
          { responseType: 'blob' },
        );
